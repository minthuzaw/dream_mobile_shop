...
<div class="container">
    <div class="row">
        <div class="col-12 text-center pt-2">
            <form id="add-frm" method="POST" action="{{route('phones.update',$phone->id)}}" enctype="multipart/form-data"
                  class="border p-3 mt-2 col-6">
                @csrf
                @method('PUT')
                ...
                <div class="control-group  text-left mt-2">
                    ...
                    <div>
                        <textarea name="description" id="description" cols="58"
