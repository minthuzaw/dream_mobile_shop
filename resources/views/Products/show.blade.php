                    ...
                    <div class="product_description">
                        ...
                        <hr class="singleline">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="1" max="" value="1" name="quantity" class="quantity-field" style="width: 60px">
                                <input type="button" value="+" class="button-plus" data-field="quantity">
                            </div>
                            <div class="col-xs-6 mt-3"> <button type="button" class="btn btn-primary shop-button">Add to Cart</button>
                            </div>
                    </div>
                </div>
            </div>
